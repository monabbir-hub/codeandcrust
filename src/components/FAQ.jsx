...
const FAQCard = ({ index, question, answer }) => {
  ...
  return (
    <div className="xs:w-[1000px] w-full">
      ...
      >
        <div className="bg-tertiary rounded-[20px] py-5 px-12 min-h-[80px] flex flex-col justify-between items-start">
          <div
          ...
          {isOpen && (
            <p className="text-emerald-400 text-md mt-4" style={{ whiteSpace: "pre-line" }}>
              {answer}
            </p>
          )}
        </div>
